...
1. Edit the `idps.py` script and set the `path`c variable to the directories you want to monitor.
...
To test the IDPS functionality on the sample idps_test folder, see the instructions in `idps_test/README_TEST.md` and use the provided `test_idps_events.py` script to simulate file events.
